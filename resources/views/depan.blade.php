@php
  $_site_name = get_setting_value('_site_name');  
  $jumbotron = get_section_data('JUMBOTRON');
  $_location = get_setting_value('_location'); 
  $_site_description = get_setting_value('_site_description'); 
...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand" href="#page-top">{{ $_site_name}}</a>
...
    @endforeach
    ...
    <div class="copyright py-4 text-center text-white">
      <div class="container"><small>Copyright &copy; {{ $_site_name}} 2023</small></div>
    </div>
